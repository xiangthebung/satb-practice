...
| --- | --- | --- | --- |
| Happy birthday to you | SATB | 9 bars | Melody in the soprano; the three lower parts stay inside a fifth. A first score. |
...
Everything here is public domain, and the two written for this repository are
generated by scripts so the music can be edited rather than re-engraved:
...
"Happy Birthday to You" is Mildred J. Hill's 1893 melody with the lyrics that
`Marya v. Warner/Chappell Music` (C.D. Cal. 2015, settled June 2016) held to be
unprotected; the four-part setting is written for this repository. Each script's
header carries the full provenance, including why a fourth sample was removed
from an earlier version of this repository for copyright.
